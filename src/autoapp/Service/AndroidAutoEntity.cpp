...
void AndroidAutoEntity::onServiceDiscoveryRequest(const aasdk::proto::messages::ServiceDiscoveryRequest& request)
{
    ...
    serviceDiscoveryResponse.set_head_unit_name("G37");
    serviceDiscoveryResponse.set_car_model("Universal");
    serviceDiscoveryResponse.set_car_year("2011");
    ...
    serviceDiscoveryResponse.set_headunit_manufacturer("Infiniti");
    serviceDiscoveryResponse.set_headunit_model("Raspberry Pi 3");
